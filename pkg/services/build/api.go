...
func (_Api *ApiCaller) Exists(opts *bind.CallOpts, id *big.Int) (bool, error) {
	var out []interface{}
	err := _Api.contract.Call(opts, &out, "exists", id)
...
//
// Solidity: function exists(uint256 id) view returns(bool)
func (_Api *ApiSession) Exists(id *big.Int) (bool, error) {
	return _Api.Contract.Exists(&_Api.CallOpts, id)
}

// Exists is a free data retrieval call binding the contract method 0x4f558e79.
//
// Solidity: function exists(uint256 id) view returns(bool)
func (_Api *ApiCallerSession) Exists(id *big.Int) (bool, error) {
	return _Api.Contract.Exists(&_Api.CallOpts, id)
}
...
func (_Api *ApiCaller) TotalSupply(opts *bind.CallOpts, id *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Api.contract.Call(opts, &out, "totalSupply", id)
...
//
// Solidity: function totalSupply(uint256 id) view returns(uint256)
func (_Api *ApiSession) TotalSupply(id *big.Int) (*big.Int, error) {
	return _Api.Contract.TotalSupply(&_Api.CallOpts, id)
}

// TotalSupply is a free data retrieval call binding the contract method 0xbd85b039.
//
// Solidity: function totalSupply(uint256 id) view returns(uint256)
func (_Api *ApiCallerSession) TotalSupply(id *big.Int) (*big.Int, error) {
	return _Api.Contract.TotalSupply(&_Api.CallOpts, id)
}
...
func (_Api *ApiTransactor) Mint(opts *bind.TransactOpts, account common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _Api.contract.Transact(opts, "mint", account, id, amount, data)
}

// Mint is a paid mutator transaction binding the contract method 0x731133e9.
//
// Solidity: function mint(address account, uint256 id, uint256 amount, bytes data) returns()
func (_Api *ApiSession) Mint(account common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _Api.Contract.Mint(&_Api.TransactOpts, account, id, amount, data)
}

// Mint is a paid mutator transaction binding the contract method 0x731133e9.
//
// Solidity: function mint(address account, uint256 id, uint256 amount, bytes data) returns()
func (_Api *ApiTransactorSession) Mint(account common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _Api.Contract.Mint(&_Api.TransactOpts, account, id, amount, data)
}
...
func (_Api *ApiTransactor) MintBatch(opts *bind.TransactOpts, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _Api.contract.Transact(opts, "mintBatch", to, ids, amounts, data)
}

// MintBatch is a paid mutator transaction binding the contract method 0x1f7fdffa.
//
// Solidity: function mintBatch(address to, uint256[] ids, uint256[] amounts, bytes data) returns()
func (_Api *ApiSession) MintBatch(to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _Api.Contract.MintBatch(&_Api.TransactOpts, to, ids, amounts, data)
}

// MintBatch is a paid mutator transaction binding the contract method 0x1f7fdffa.
//
// Solidity: function mintBatch(address to, uint256[] ids, uint256[] amounts, bytes data) returns()
func (_Api *ApiTransactorSession) MintBatch(to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _Api.Contract.MintBatch(&_Api.TransactOpts, to, ids, amounts, data)
}
